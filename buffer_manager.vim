...
" Map specific buffers to keys (e.g., <leader>q, <leader>w)
nnoremap <leader>q :call GoToBuffer(0)<CR>
nnoremap <leader>w :call GoToBuffer(1)<CR>
nnoremap <leader>e :call GoToBuffer(2)<CR>
nnoremap <leader>r :call GoToBuffer(3)<CR>
nnoremap <leader>t :call GoToBuffer(4)<CR>
